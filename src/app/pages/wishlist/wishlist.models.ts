export interface WishlistItem {
  ...
  export type Brand = 'ACADEMY' |'AIRFIX' |'AZUR' |'CLASSIC PLANE' |'CMK' |'CONDOR' |'DML/DRAGON' |'EDUARD' |'IBG Models' |'FINE MOLDS' |'FUJIMI' |'HASEGAWA' |'HELLER' |'HOBBYCRAFT' |'ICM' |'ITALERI' |'KANGNAM' |'KP' |'M. PRO-MODELLER' |'MACH 2' |'MATCHBOX' |'MINICRAFT' |'MODELCRAFT' |'MONOGRAM' |'MPM' |'PREMIERE' |'REVELL' |'RODEN' |'SMER' |'SPECIAL HOBBY' |'SWORD' |'TAMIYA' |'TRUMPETER' |'ZVEZDA' | 'ANY';